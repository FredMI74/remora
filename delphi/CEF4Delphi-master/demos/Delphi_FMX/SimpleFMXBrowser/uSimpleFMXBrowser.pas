...
s: string;
 ...
 f : TStrings;
begin
 // s := 'document.getElementById('#39'EntrarBtn'#39').click();';

  s := 'document.querySelector('#39'#button-buy'#39').click();';
  frame := FMXChromium1.Browser.GetFrame('content-page');
 //f := TStrings.Create;

 // FMXChromium1.Browser.GetFrameNames(f);


  frame.ExecuteJavaScript(s, frame.Url, 0);

//  <iframe src="/Pages/Clear/Operacoes/RendaVariavel/DayTrade.aspx" name="content-page" frameborder="0" class="ifm"></iframe>
